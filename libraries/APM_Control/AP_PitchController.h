...
public:
	...
	int32_t get_servo_out(int32_t angle_err, int32_t desired_roll, float scaler, bool disable_integrator);
...
private:
    ...
    float   _get_coordination_rate_offset(float desired_roll, float &aspeed, bool &inverted) const;
